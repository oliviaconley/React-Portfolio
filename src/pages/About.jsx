...
export default function About() {
  return (
    <section
      className="flex flex-col flex-wrap justify-center items-center p-12"
      id="about"
    >
      ...
      <img
        className="shadow rounded-full max-w-xs h-auto align-middle border-2 border-black"
        src={Headshot}
        alt="Headshot"
      ></img>
      <div className="flex flex-row p-8">
        ...
        <div className="pl-8">
          <a href="#contact">
            {" "}
            <button className="transition ease-in-out delay-150 bg-white hover:-translate-y-1 hover:scale-100 duration-300 rounded-full py-2 px-4 border-black border">
              Contact
            </button>
          </a>
        </div>
      ...
      <div className="flex flex-cols-2 flex-wrap p-24">
        <div className="w-96">
          <img
            className="rounded-full max-w-xs h-auto w-64 h-64 align-middle border-2 border-black"
            src={Olivia}
            alt="Olivia"
          ></img>
        ...
        <div className="w-96 px-4">
          ...
          <p>
            <b>A full-stack web developer</b> with expertise in multimedia
            production.
          </p>
          <p className="py-2">
            <b>An agile self-starter</b> who gets the tough stuff done.
          </p>
          <p className="py-2">
            <b>A confident leader</b> with a passion for learning and
            team-building.
          </p>
          <p className="py-2">
            <b>A master collaborator</b> with a strong perspective.
          </p>
          <p className="py-2">
            <b>A creative problem-solver</b> with a sharp eye for detail.
          </p>
          <p className="py-2">
            <b>Bilingual in English and Spanish</b>, and always curious to learn
            from others.
          </p>
        </div>
      </div>
