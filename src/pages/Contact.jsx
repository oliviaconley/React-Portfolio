      ...
      <div>
        ...
        <div className="flex flex-cols-2 flex-wrap text-center w-full pb-10">
          ...
          <div className='m-2 p-6 rounded-full border-2 border-white bg-black'>
            ...
            {/* <div className='text-xs text-white'>Let's connect</div> */}
          </div>
          ...
          <div className='m-2 p-6 rounded-full border-2 border-white bg-black'>
            ...
            {/* <div className='text-xs text-white'>My work</div> */}
          </div>
            ...
            <div>
              <div>
                ...
                <div className="p-2 center">
                  <input type="email" name="email" className="rounded-lg max-w-full w-96 border-black border" placeholder="Email Address" required/>
                </div>
              </div>
            </div>
